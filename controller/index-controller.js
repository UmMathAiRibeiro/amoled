...
class IndexController {
    ...
    Senão, redireciona ele para a tela de login. Passamos para a tela de login o parâmetro "titulo" com valor "Agenda de tarefas". 
    Esse parâmetro será exibido na página "index.ejs", que está na pasta "views"
